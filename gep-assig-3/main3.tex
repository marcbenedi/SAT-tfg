...
\addbibresource{assig3.bib} % The filename of the bibliography
...
\thesistitle{Deliverable 3: Budget and sustainability} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\include{Chapters/SelfAssessmentSustainability}
\include{Chapters/AnalysisSustainability}
