...
\addbibresource{assig5.bib} % The filename of the bibliography
...
\thesistitle{Deliverable 5: Final module of the speciality Computer Science} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\include{Chapters/Ch1-Objectives}
\include{Chapters/Ch2-Scope}
\include{Chapters/Ch3-Courses}
\include{Chapters/Ch4-ComputerScience}
\include{Chapters/Ch5-Competences}
