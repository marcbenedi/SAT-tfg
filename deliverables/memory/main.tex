...
\thesistitle{Facultat d'informàtica de Barcelona} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\begin{abstract}
    ...
    \begin{center}
    	All the source code can be found here:  \\ \href{https://github.com/marcbenedi/SAT-TFG}{https://github.com/marcbenedi/SAT-TFG}
    \end{center}
...
\include{Chapters/Ch3-Development}
\include{Chapters/Ch4-SearchAlgorithms}
\include{Chapters/Ch5-Timeouts}
\include{Chapters/Ch6-ProjectPlanning}
\include{Chapters/Ch7-EconomicManagement}
\include{Chapters/Ch8-SustainabilitySocialCommitment}
\include{Chapters/Ch9-ExperimentsResults}
\include{Chapters/Ch10-Conclusions}
...
%\include{Appendices/SearchAlgorithms}
\include{Appendices/GoogleTest}
%----------------------------------------------------------------------------------------
%	BIBLIOGRAPHY
%----------------------------------------------------------------------------------------
