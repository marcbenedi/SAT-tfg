...
\begin{table}[h!]
	\centering
		\begin{tabular}{|l|r|r|r|}
			...
			Product Manager &  & 27 &  \\ \hline
			Software Architect &  & 25 &  \\ \hline
			Developer &  & 14 &  \\ \hline\hline
			Total & \multicolumn{3}{r|}{X} \\ \hline
		\end{tabular}%
...
\begin{table}[h!]
	...
	\label{real-cost}
\end{table}
The difference between the estimated cost, 13.977,48€, and the real one, XXXX, is YYYY.\\\\
As previously mentioned, the difference is due to the reduction of hours needed for the project, contingency, and unforeseen. 