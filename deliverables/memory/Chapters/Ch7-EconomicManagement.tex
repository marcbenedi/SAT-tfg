...
\begin{table}[h!]
	\centering
		\begin{tabular}{|l|r|r|r|}
			\hline
			\multicolumn{1}{|c|}{Stage} & \multicolumn{1}{c|}{Product Manager (h)} & \multicolumn{1}{c|}{Software Architect (h)} & \multicolumn{1}{c|}{Developer (h)} \\ \hline
			GEP & 70 & 0 & 0 \\ \hline
...
\begin{table}[h!]
	\centering
		\begin{tabular}{|l|r|r|r|}
			\hline
			\multicolumn{1}{|c|}{Role} & \multicolumn{1}{c|}{Price/Hour (€/h)} & \multicolumn{1}{c|}{Hours (h)} & \multicolumn{1}{c|}{Cost (€)} \\ \hline
